...
class Hardware(private val host: ControllerHost, midiHandler: ShortMidiDataReceivedCallback, sysexHandler: SysexMidiDataReceivedCallback) : ShortMidiDataReceivedCallback {
    ...
    private var isOctaveDownPressed = false
    private var isOctaveUpPressed = false
    ...
    init {
        ...
        portIn.setMidiCallback(midiHandler)
        portIn.setSysexCallback(sysexHandler)

        portOut.sendSysex(DeviceMemory)

        val padVelocitySettings = host.preferences.getEnumSetting("Pads", "Velocity Curve", arrayOf("Linear", "Logarithmic", "Exponential", "Full"), "Linear")
        ...
        val keyVelocitySettings  = host.preferences.getEnumSetting("Keyboard", "Velocity Curve", arrayOf("Linear", "Logarithmic", "Exponential", "Full"), "Linear")
        ...
        val knobAccelerationSettings   = host.preferences.getEnumSetting("Knobs", "Acceleration", arrayOf("Slow (Off)", "Medium", "Fast"), "Slow (Off)")
