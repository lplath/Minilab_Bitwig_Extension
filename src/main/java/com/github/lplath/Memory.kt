...
object Memory {
    ...
    private fun writeTo(port: MidiOut, bank: Int) {
        port.sendSysex(DeviceMemory)
        port.sendSysex("F0 00 20 6B 7F 42 06 0$bank F7")
    }

    private const val DeviceMemory =
        "F0 00 20 6B 7F 42 02 00 01 0A 01 F7" +
                ...
                "F0 00 20 6B 7F 42 02 00 41 01 00 F7" +
                ...
                "F0 00 20 6B 7F 42 02 00 41 03 00 F7" +
