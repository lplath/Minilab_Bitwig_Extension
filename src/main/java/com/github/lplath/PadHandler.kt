...
class PadHandler(private val host: ControllerHost, private val hardware: Hardware, mapping: Mapping) {
	...
	init {
		...
		mapping.onDown(Mapping.PADS_1) { index ->
			host.println("Macro pressed")
